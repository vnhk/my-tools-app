...
public class ReactLanguageLearningE2ETest extends BaseTest {
    ...
    public void runPlaywrightIntegrationTests() throws Exception {
        ...
        String command = "npx playwright test --config playwright.integration.config.ts e2e/integration/language-learning/language-learning.spec.ts";
